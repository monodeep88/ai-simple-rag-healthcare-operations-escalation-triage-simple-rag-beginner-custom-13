...
**Healthcare Operations Escalation Triage** is not a static prompt demo. It is a runnable full-stack AI application for **Healthcare Operations Escalation Triage Simple RAG - Beginner Custom 13** that demonstrates the core expectations of a **Simple RAG** project at **Beginner** difficulty.
