...
Build **Healthcare Operations Escalation Triage**, a Beginner Simple RAG application for **Healthcare Operations Escalation Triage Simple RAG - Beginner Custom 13** that turns a user question into an explainable answer with citations, timeline steps, and stored run history.
