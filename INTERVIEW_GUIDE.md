...
This is a Beginner **Simple RAG** project for **Healthcare Operations Escalation Triage Simple RAG - Beginner Custom 13**. It demonstrates a React user interface, FastAPI backend, retrieval/workflow pipeline, stored run history, Docker setup, and tests.
