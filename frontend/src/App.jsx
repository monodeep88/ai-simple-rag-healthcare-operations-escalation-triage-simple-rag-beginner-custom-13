...
const PROJECT_SUBJECT = "Healthcare Operations Escalation Triage Simple RAG - Beginner Custom 13";
const DOMAIN_SUMMARY = "{'description': 'Healthcare operations escalation triage system', 'key_terms': ['healthcare', 'operations', 'escalation', 'triage'], 'pain_points': ['Long response times', 'Inconsistent decision-making', 'High staff workload']}";
const USER_PERSONA = "Healthcare Operations Manager: Responsible for managing healthcare operations and making timely decisions";
const STARTER_QUESTIONS = ["What is the patient's medical history?", "What are the patient's symptoms?", "What is the patient's current condition?"];
